...
const AntigravityInner = ({
    ...
    // 🔹 mouse global (bukan dari state.pointer)
    const mouse = useRef({ x: 0, y: 0 });

    useEffect(() => {
        const handleMove = (e) => {
            // normalisasi ke -1..1 seperti state.pointer
    ...
    useFrame((state) => {
        ...
        const m = mouse.current; // 🔹 pakai mouse global
...
const Antigravity = (props) => {
    return (
        <Canvas
            ...
            gl={{ alpha: true }}                     // 🔹 izinkan transparan
            onCreated={({ gl }) => {
                gl.setClearColor(0x000000, 0);         // 🔹 background Canvas = transparent
            }}
        >
